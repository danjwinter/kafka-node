...
Offset.prototype.fetch = function (payloads, cb) {
  if (!this.ready) {
    console.log(`NOT READY, REGISTERING LISTENER`);
...
Offset.prototype.fetchCommitsV1 = function (groupId, payloads, cb) {
  ...
  // this.client.setCoordinatorIdAndSendOffsetFetchV1Request(groupId, this.buildPayloads(payloads), cb);
